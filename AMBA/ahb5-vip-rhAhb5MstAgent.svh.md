...
```
For `config.ifCtrl`, refer to [[ahb5-vip-rhAhb5MstConfig.svh#Interface Controller]].
## setupSubComponents
...
```
reference:
[[ahb5-vip-rhAhb5MstDriver.svh]]
[[src-rhAhb5MstSeqr.svh]], #TODO 
[[ahb5-vip-rhAhb5MstConfig.svh]]
[[ahb5-vip-rhAhb5MstMonitor.svh]], #TODO 
## connect_phase
