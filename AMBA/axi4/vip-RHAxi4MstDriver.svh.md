RHAxi4MstDriver is a uvm_driver, based on [[vip-RHAxi4DriverBase.svh]], which is a common driver base for master and slave axi4 device.

# Source Code
**codeType** `systemverilog`

**driver** RhAxi4MstDriver
The transaction of this master driver is pre-defined in [[vip-RHAxi4DriverBase.svh]].
...
**ref**
[[vip-RHAxi4MstConfig.svh#BCycleConfig]]
**proc**
```systemverilog
forever begin
