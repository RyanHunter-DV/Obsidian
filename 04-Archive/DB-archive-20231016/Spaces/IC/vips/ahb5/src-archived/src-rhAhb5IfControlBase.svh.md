This is a base class defined for place holder of an interface controller definition, it's parameterized subclass is defined: [[Spaces/IC/vips/ahb5/src-archived/src-rhAhb5IfControl.svh]].
# Source Code
